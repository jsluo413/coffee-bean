# Green coffee beans production - Data package

This data package contains the data that powers the chart ["Green coffee beans production"](https://ourworldindata.org/grapher/coffee-bean-production?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website. It was downloaded on April 30, 2026.
...
#### Full citation
Food and Agriculture Organization of the United Nations (2025) – with major processing by Our World in Data. “Coffee bean production – UN FAO” [dataset]. Food and Agriculture Organization of the United Nations, “Production: Crops and livestock products” [original data].
